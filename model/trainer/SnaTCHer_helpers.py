...
from model.models.SnaTCHerF import SnaTCHerF
...
def get_dataloader(args):
    ...
    elif 'Cross' in args.dataset:
        i = 0
    else:
        raise ValueError('Non-supported Dataset.')
    
    
    from model.dataloader.tiered_imagenet import tieredImageNet as TDataset
    from model.dataloader.cub import CUB as CDataset
    if args.dataset == 'CrossTC':
      Dataset1 = TDataset
      Dataset2 = CDataset
    elif args.dataset == 'CrossCT':
      Dataset1 = CDataset
      Dataset2 = TDataset
    ...
    trainset = Dataset2('train', args, augment=args.augment)
